...
export const TURKEY_DATA: CityData[] = [
    ...
    { name: "Çankırı", districts: ["Atkaracalar", "Bayramören", "Çerkeş", "Eskipazar", "Ilgaz", "Kızılırmak", "Korgun", "Kurşunlu", "Merkez", "Orta", "Şabanözü", "Yapraklı"] },
    ...
    { name: "Kayseri", districts: ["Akkışla", "Bünyan", "Develi", "Felahiye", "Hacılar", "İncesu", "Kocasinan", "Develi", "Melikgazi", "Özvatan", "Pınarbaşı", "Sarıoğlan", "Sarız", "Talas", "Tomarza", "Yahyalı", "Yeşilhisar"] },
    ...
    { name: "Zonguldak", districts: ["Alaplı", "Çaycuma", "Devrek", "Gökçebey", "Kilimli", "Kozlu", "Merkez", "Karadeniz Ereğli"] },
