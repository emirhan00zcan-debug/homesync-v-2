...
export default function VendorSidebar() {
    ...
    const links = [
        ...
        { icon: BarChart3, label: "Satış Grafikleri", href: "/dashboard/vendor/sales" },
    ...
    return (
        <aside className="w-20 lg:w-72 border-r border-white/10 flex flex-col p-6 sticky top-0 h-screen bg-cosmic-blue z-50 shadow-2xl">
            <Link href="/dashboard/vendor" className="mb-12 flex items-center gap-4 group">
                ...
                <div className="hidden lg:block">
                    ...
                    <p className="text-[10px] text-radiant-amber font-bold uppercase tracking-widest">Mağaza Paneli</p>
                </div>
            </Link>
            ...
            <div className="mt-auto border-t border-white/10 pt-8 space-y-3">
                ...
                <div className="hidden lg:flex items-center gap-3 p-4 glass rounded-3xl border border-white/5 bg-white/[0.02]">
                    ...
                    <div className="flex-1 overflow-hidden">
                        ...
                        <p className="text-[9px] text-white/40 truncate text-radiant-amber">Satıcı Hesabı</p>
                    </div>
                </div>
            </div>
        </aside>
